class Film {
    ...
    constructor(title, Genre, director, totalTimeInminutes, watchedTimeInMinutes, shortDiscription, linkyoutube) {
        this.title = title;
        this.Genre = Genre;
...
for (let Film of Films) {
    ...
    htmlElements0 +=
        ...
        <img src="${Film.linkImage}" alt="${Film.title}">
            <div class="card-body">
                <p class="card-text"><h2>${Film.title}</h2><br>
                <h3>(${Film.Genre})</h3></p>
                <p class="director">Réaliser par:</p><h4>${Film.director}</h4>
